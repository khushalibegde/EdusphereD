...
const DiwaliPage = ({ navigateTo }: ContentScreenProps) => {
  ...
  return (
    <View className="flex-1 bg-white p-6">
      ...
      <View className="flex-1 items-center justify-center">
        {/* Lottie Animation */}
        <LottieView 
          source={require("../../assets/animations/diwali animation.json")}
          autoPlay 
          loop 
        ...
        <View className="flex-row items-center mt-6">
          <Text className="text-3xl font-bold text-black">Happy Diwali</Text>
          <TouchableOpacity onPress={() => speak("Happy Diwali")} className="ml-3">
      ...
      <TouchableOpacity 
        ...
        onPress={()=>navigateTo("DiwaliItemsPage")}
      >
