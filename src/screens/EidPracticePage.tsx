...
const questions = [
  {
    question: "Which one is a Mosque?",
    options: [
      { image: require("../../assets/images/mosque.jpg"), isCorrect: true, label: "Mosque" },
      { image: require("../../assets/images/quran.jpg"), isCorrect: false, label: "Quran" },
      { image: require("../../assets/images/henna2.jpg"), isCorrect: false, label: "Henna" }
    ]
  },
  {
    question: "What is read on Eid?",
    options: [
      { image: require("../../assets/images/mosque.jpg"), isCorrect: false, label: "Mosque" },
      { image: require("../../assets/images/quran.jpg"), isCorrect: true, label: "Quran" },
      { image: require("../../assets/images/henna2.jpg"), isCorrect: false, label: "Henna" }
    ]
  }
];
...
export default EidPracticePage;
